...
{
    /// <summary>
    /// A custom JSON converter for the Kraken <see cref="KrakenCandle"/> class
    /// </summary>
    public class KrakenCandlesConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            return objectType == typeof(KrakenCandle);
        }
    }
}